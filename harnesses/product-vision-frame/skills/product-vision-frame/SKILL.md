...
description: Define a product's singular purpose and ruthlessly align all decisions to that vision, rejecting good ideas that do not serve the core.
license: MIT
metadata:
  version: 1.0.0
  author: hgflima
...
|-------|----------|-------------|---------|
| product_concept | Yes | Current product or product idea | "An AI-powered code review tool for small teams" |
| target_users | No | Who the product is intended for | "Solo developers and teams of 2–5 working on open-source projects" |
| feature_ideas | No | Current backlog or ideas under consideration | "Auto-fix suggestions, PR summaries, security scanning, Slack integration, IDE plugin" |
| competitive_context | No | What alternatives exist | "GitHub Copilot, CodeRabbit, Sourcery — all target enterprise" |
| constraints | No | Technical, resource, or market constraints | "3-person team, $50k runway, must ship MVP in 8 weeks" |
...
Would a visionary leader greenlight this vision?
